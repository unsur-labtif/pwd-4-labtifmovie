      ...
      <div class="card">
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-grid">
            ...
            <div class="input-group">
              <input type="file" id="cover" class="file-input" name="cover" accept="image/jpg, image/png, image/jpeg" required />
            </div>
          </div>
        ...
        <?php 
            ...
            if(isset($_POST['submit'])){
                ...
                $movie->addMovie($data);
                echo "<script>alert('Data Berhasil Di Simpah'); window.location.href='index.php'</script>";
